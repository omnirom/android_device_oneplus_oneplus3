...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private void handleKey(int scanCode) {
        ...
        case GESTURE_V_SCANCODE:
            String value = Settings.System.getStringForUser(mContext.getContentResolver(),
                    DeviceSettings.DEVICE_GESTURE_MAPPING_2, UserHandle.USER_CURRENT);
    ...
    public boolean isCameraLaunchEvent(KeyEvent event) {
        ...
        String value = Settings.System.getStringForUser(mContext.getContentResolver(),
                DeviceSettings.DEVICE_GESTURE_MAPPING_1, UserHandle.USER_CURRENT);
        if (TextUtils.isEmpty(value) || value.startsWith("default#")) {
    ...
    public Intent isActivityLaunchEvent(KeyEvent event) {
        ...
        if (event.getScanCode() == GESTURE_II_SCANCODE) {
            String value = Settings.System.getStringForUser(mContext.getContentResolver(),
                    DeviceSettings.DEVICE_GESTURE_MAPPING_0, UserHandle.USER_CURRENT);
            if (!TextUtils.isEmpty(value) && !value.startsWith("default#")) {
            ...
            String value = Settings.System.getStringForUser(mContext.getContentResolver(),
                    DeviceSettings.DEVICE_GESTURE_MAPPING_3, UserHandle.USER_CURRENT);
            ...
            if (!isMusicGestureEnabled()) {
                String value = Settings.System.getStringForUser(mContext.getContentResolver(),
                        DeviceSettings.DEVICE_GESTURE_MAPPING_4, UserHandle.USER_CURRENT);
                if (!TextUtils.isEmpty(value)) {
            ...
            if (!isMusicGestureEnabled()) {
                String value = Settings.System.getStringForUser(mContext.getContentResolver(),
                        DeviceSettings.DEVICE_GESTURE_MAPPING_5, UserHandle.USER_CURRENT);
                if (!TextUtils.isEmpty(value)) {
