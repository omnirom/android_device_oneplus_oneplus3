...
public class GestureSettings extends PreferenceActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mMusicApp.setEnabled(DoubleSwipeGestureSwitch.isSupported());
