...
public class Startup extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent bootintent) {
        ...
        boolean enabled = sharedPrefs.getBoolean(DeviceSettings.KEY_TORCH_SWITCH, false);
        restore(context, TorchGestureSwitch.getFile(), enabled);
        enabled = sharedPrefs.getBoolean(DeviceSettings.KEY_UP_ARROW_SWITCH, false);
        restore(context, UpArrowGestureSwitch.getFile(), enabled);
        enabled = sharedPrefs.getBoolean(DeviceSettings.KEY_CAMERA_SWITCH, false);
        restore(context, CameraGestureSwitch.getFile(), enabled);
        enabled = sharedPrefs.getBoolean(DeviceSettings.KEY_MUSIC_SWITCH, false);
        ...
        enabled = sharedPrefs.getBoolean(DeviceSettings.KEY_LEFT_ARROW_SWITCH, false);
        restore(context, LeftArrowGestureSwitch.getFile(), enabled);
        enabled = sharedPrefs.getBoolean(DeviceSettings.KEY_RIGHT_ARROW_SWITCH, false);
